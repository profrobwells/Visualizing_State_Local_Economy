...
> [Click here to download the Excel tables: "CNTL" + click for a New Tab](https://www.bea.gov/newsreleases/regional/gdp_metro/2017/xls/gdp_metro0917.xlsx){target="_blank"}
...
> [Cleaned Data: "CNTL" + click for a New Tab](https://docs.google.com/spreadsheets/d/18AgvFvHJruJUrU6LLbdI162Tjyfi4GdV0iBXgYg3IkY/edit#gid=910642061){target="_blank"}
...
* Tweak the chart.   
    ...
    + Double Click on the heading, "Sheet 1" and type in a headline. I typed "Fayetteville leads Arkansas GDP Growth in 2016
...
> [Tableau Chart: "CNTL" + click for a New Tab](https://public.tableau.com/profile/rob.wells#!/vizhome/SabewTable1/ArkansasGDP?publish=yes){target="_blank"}
