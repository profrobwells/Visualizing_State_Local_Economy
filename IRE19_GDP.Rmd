...
<img src="Images-Sabew/Reynolds logo2.jpg" width="400" height="400" />    
<br>  
<br>  
...
> [GDP Release: "CNTL" + click for a New Tab](https://www.bea.gov/newsreleases/regional/gdp_metro/gdp_metro_newsrelease.htm){target="_blank"}
...
> [Click here to download the Excel tables: "CNTL" + click for a New Tab](https://www.bea.gov/system/files/2018-09/gdp_metro0918.xlsx){target="_blank"}
...
> The Google sheet you have has been cleaned and modified so it will play well with Tableau. Basically, the BEA spreadsheet was cleaned to remove merged cells, states were split off into a new column, a data dictionary was created to keep track of our changes and new headers were created. Here is a 10-minute video on how to do this yourself:
...
* Tweak the chart.   
    ...
    + Double Click on the heading, "Sheet 1" and type in a headline. I typed "Arkansas' Cities Lag U.S. in 2017 GDP Growth
